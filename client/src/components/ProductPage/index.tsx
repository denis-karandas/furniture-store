...
import { Breadcrumbs, ImageGallery, Rating, ProductReviews, ProductQuestions, ProductDetails, ProductRating, ProductColors } from 'components';
import { Button, ProductFilter } from 'HOCs';
